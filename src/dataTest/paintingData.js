const paintingData = [
  {
    ...
    artObjects: [
      {
        links: {
          self: "https://www.rijksmuseum.nl/api/en/collection/SK-C-5",
          web: "https://www.rijksmuseum.nl/en/collection/SK-C-5",
        },
        id: "en-SK-C-5",
        objectNumber: "SK-C-5",
      ...
      },
      {
        ...
        hasImage: true,
        principalOrFirstMaker: "Rembrandt van Rijn",
        longTitle: "Landscape with a Stone Bridge, Rembrandt van Rijn, c. 1638",
        showImage: true,
        permitDownload: true,
        webImage: {
      ...
      },
      {
        ...
        hasImage: true,
        principalOrFirstMaker: "Rembrandt van Rijn",
        longTitle: "Young Woman in Fantasy Costume, Rembrandt van Rijn, 1633",
        showImage: true,
        permitDownload: true,
        webImage: {
      ...
      },
      {
        ...
        hasImage: true,
        principalOrFirstMaker: "Rembrandt van Rijn",
        longTitle: "Portrait of Ephraim Bueno, Rembrandt van Rijn, 1645 - 1647",
        showImage: true,
        permitDownload: true,
        webImage: {
    ...
    facets: [
      {
        facets: [
          ...
          {
            key: "Jean Pierre Norblin de la Gourdaine",
            value: 4,
          },
          {
      ...
      },
      {
        facets: [
          ...
          {
            key: "photomechanical print",
            value: 10,
          },
          {
            key: "cabinet photograph",
            value: 4,
          },
          {
            key: "fragment",
